...
Repozytorium projektowe robota mobilnego z napędem mecanum, zrealizowanego w ramach pracy dyplomowej. Zawiera schematy elektroniczne (Altium Designer), pliki produkcyjne PCB (Gerber) oraz projekt oprogramowania wbudowanego (ESP-IDF).

## Schematy projektowe -- Altium Designer
...
## Pliki projektu oprogramowania -- ESP-IDF

- `CMakeLists.txt` -- główny plik konfiguracyjny projektu (poziom katalogu głównego)
